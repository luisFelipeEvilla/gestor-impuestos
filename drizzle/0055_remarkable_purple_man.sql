CREATE TYPE "public"."estado_impuesto" AS ENUM('pendiente', 'declarado', 'liquidado', 'notificado', 'en_cobro_coactivo', 'pagado', 'cerrado');--> statement-breakpoint
CREATE TYPE "public"."tipo_evento_impuesto" AS ENUM('cambio_estado', 'asignacion', 'nota');--> statement-breakpoint
CREATE TYPE "public"."tipo_periodo_impuesto" AS ENUM('bimestral', 'trimestral', 'semestral', 'anual');--> statement-breakpoint
ALTER TABLE "comparendos" DROP CONSTRAINT IF EXISTS "comparendos_impuesto_id_impuestos_id_fk";--> statement-breakpoint
ALTER TABLE "comparendos" DROP COLUMN IF EXISTS "impuesto_id";--> statement-breakpoint
...
DROP TYPE IF EXISTS "public"."naturaleza_impuesto";
