...
export type DatumEstadoImpuesto = { estado: string; count: number };

interface GraficoImpuestosPorEstadoProps {
  data: DatumEstadoImpuesto[];
}

export function GraficoImpuestosPorEstado({ data }: GraficoImpuestosPorEstadoProps) {
