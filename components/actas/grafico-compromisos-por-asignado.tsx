...
export type DatumAsignado = { nombre: string; count: number };

const BAR_COLOR = "var(--chart-2)";

interface GraficoCompromisosPorAsignadoProps {
  data: DatumAsignado[];
}

const MAX_BARS = 10;

export function GraficoCompromisosPorAsignado({ data }: GraficoCompromisosPorAsignadoProps) {
