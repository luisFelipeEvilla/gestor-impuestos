...
export function CardGeneral({
  ...
  const CATEGORIA_GENERAL: CategoriaNota = "general";

  return (
    <Card className="max-w-xl">
      <CardHeader>
        <CardTitle>General del proceso</CardTitle>
        <CardDescription>
          Documentos y comentarios generales del proceso (no asociados a una etapa concreta).
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        <div className="space-y-2">
          <h4 className="text-sm font-medium">Comentarios (General)</h4>
          <AgregarNotaForm procesoId={procesoId} categoria={CATEGORIA_GENERAL} />
          <ListaNotas notas={notas} />
        </div>
        <div className="space-y-2">
          <h4 className="text-sm font-medium">Documentos (General)</h4>
          <SubirDocumentoForm procesoId={procesoId} categoria="general" />
          <ListaDocumentos procesoId={procesoId} documentos={documentos} puedeEliminar />
        </div>
      </CardContent>
    </Card>
